...
urlpatterns = [
    ...
    path("euro/", include(("eurocalc.urls", "eurocalc"), namespace="eurocalc")),  # [ADDED] Expose /euro/api for SPA
    path(
        "vite.svg",
        static_serve,
...
path("api/", include(("eurocalc.urls", "eurocalc"), namespace="eurocalc_api")),
